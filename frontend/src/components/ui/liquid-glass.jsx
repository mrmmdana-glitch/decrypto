...
// Converted from TSX — no TypeScript, adapted for dark purple theme.
...
export const GlassEffect = ({
  ...
  const glassStyle = {
    boxShadow: "0 6px 6px rgba(0, 0, 0, 0.35), 0 0 20px rgba(0, 0, 0, 0.2)",
  ...
  const content = (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow:
            "inset 2px 2px 1px 0 rgba(196,181,253,0.35), inset -1px -1px 1px 1px rgba(139,92,246,0.25)",
        }}
      />
      {/* Content */}
...
// Button Component — accepts onClick for React handler support
export const GlassButton = ({ children, href, onClick, className = "" }) => (
  <GlassEffect
    href={href}
    onClick={onClick}
    className={`rounded-3xl px-8 py-3.5 hover:px-9 hover:py-4 hover:rounded-4xl overflow-hidden ${className}`}
  >
    <div
...
// SVG Distortion Filter — render once near root of the page
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 items-center justify-center w-full">
        ...
        <GlassButton>
          <div className="text-xl" style={{ color: "#c4b5fd" }}>
